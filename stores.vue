                            	    ...
                            	    <div class="store_logo_container">
                            	        <router-link :to="'/stores/'+ store.slug" :aria-label="'Go to store details for ' + store.name">
                                			...
                                			<div v-if="!store.no_store_logo">
                                			    <img class="transparent_logo" src="//codecloud.cdn.speedyrails.net/sites/5b1550796e6f641cab010000/image/png/1536094421888/default_background.png" alt="default logo">
