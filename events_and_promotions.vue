            ...
            created (){
                this.loadData().then(response => {
                    ...
                    if(temp_repo != null) {
                        ...
                        this.pageBanner = {
                            "image_url": "//codecloud.cdn.speedyrails.net/sites/5de01f2f6e6f641d7c000000/image/png/1570045469000/rivermark_inside_banner.png"
                        }
                    }
                    ...
                    _.forEach(events, function (value, key) {
                        ...
                        if (today >= showOnWebDate) {
                            ...
                            if (value.store != null && value.store != undefined && _.includes(value.store.image_url, 'missing')) {
                                value.store.image_url = "//codecloud.cdn.speedyrails.net/sites/5de01f2f6e6f641d7c000000/image/png/1570045481000/rivermark_placeholder_images.png";
                            }
                            
                            if (_.includes(value.image_url, 'missing')) {
                                value.image_url = "//codecloud.cdn.speedyrails.net/sites/5de01f2f6e6f641d7c000000/image/png/1570045481000/rivermark_placeholder_images.png";
                            }
