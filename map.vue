            ...
            <div v-if="dataLoaded" v-cloak>
                ...
                <div class="main_container">
                    ...
                    <div class="row margin_60">
                        ...
                        <div class="col-md-9">
                            <mapplic-map ref="pngmap_ref" :height="664" :hovertip="true" :storelist="allStores" :floorlist="floorList" :bindLocationOpened="true" :svgWidth="property.map_image_width" :svgHeight="property.map_image_height" :showPin="true" tooltiplabel="View Store Details"></mapplic-map>
                        </div>
                    </div>
                </div>
            </div>
